		...
		<nav class="navbar navbar-expand-lg bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="#""><img alt=""
					src="/image/logo.png" style="width: 75px; height: 75px;"></a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="/filter" name="">Body
										Care</a></li>
								<li><a class="dropdown-item" href="/filter" name="">Hair
										Care</a></li>
					...
					<ul class="navbar-nav  mb-2 mb-lg-0">
						<c:if test="${!role.equals('admin')}">
							<li class="nav-item">
								<div id="ex4">
									<a href="/cart"> <span class="p1 fa-stack fa-2x has-badge"
										data-count="${productCount}"> <!--<i class="p2 fa fa-circle fa-stack-2x"></i>-->
						...
						<li class="nav-item dropdown"><a
							...
							data-bs-toggle="dropdown" aria-expanded="false"> <i
								class="fa fa-user" style="font-size: 36px"></i>
						</a>
							<ul class="dropdown-menu">
								<li><c:if test="${sessionScope.user_id != null}">
										<a class="dropdown-item" href="/profile">Profile <c:out
												value="${user.fName}" />
										</a>
									</c:if></li>
								...
								<li class=" dropdown-item"><c:choose>
										<c:when test="${sessionScope.user_id != null}">
											<div class="mr-2 logout ">
												<a href="/logout" class="icon-logout">Logout </a> <a
													href="/logout"></a> <i class="fa fa-sign-out"
													style="font-size: 25px"></i></a>
											</div>
										</c:when>
										<c:otherwise>
											<div class="mr-2 logout ">
												<a href="/" class="icon-logout">LogIn </a> <a href="/"></a><i
													class="fa fa-sign-out" style="font-size: 25px"></i></a>
											</div>
										</c:otherwise>
									</c:choose></li>
							</ul></li>
					...
					<div class="content">
						<div class="box">
							...
							<c:when test="${product.countInStock <= 3}">
								<span class="class2"><c:out value="${product.name}" /> </span> <span class="badge badge-warning">little in stock</span>
							</c:when>
							...
							<c:otherwise>
							 ...
							 <span class="class3"><c:out
									value="${product.price}" /></span>
							
						</div>
						<div class="box">
							<span class="class1">Brand</span> <span class="class2"><c:out
									value="${product.brand}" /></span>
						</div>
						<div class="box">
			...
			<div class="down-footer">
				...
				<ul class="list-inline">
					...
					<li class="list-inline-item active "><a href="#"
						class="active"><i class="fa fa-facebook"></i></a></li>

					<li class="list-inline-item"><a href="#"><i
							class="fa fa-twitter"></i></a></li>

					<li class="list-inline-item"><a
						href="mailto:icare@hotmail.com"><i class="fa fa-envelope"></i></a>
					</li>
					<li class="list-inline-item"><a href="#"><i
							class="fa fa-phone"></i></a></li>
				</ul>
				<hr>
				<a href="mailto:icare@hotmail.com" class="email">Corporate
					Headquarters 2105 S. Bascom Ave <i style="color: #eee"
					class="fa fa-envelope"></i> Copyright© 2022 icare@hotmail.com <i
					style="color: #eee" class="fa fa-phone"></i> +1 650 385 2247
				</a>
			</div>
		</div>
	</footer>
